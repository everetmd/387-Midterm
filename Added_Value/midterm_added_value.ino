...
void setup() {
    ...
    pinMode(RED_FW, OUTPUT);
    pinMode(RED_BW, OUTPUT);
    pinMode(YEL_LEFT, OUTPUT);
    pinMode(YEL_RIGHT, OUTPUT);
...
void loop() {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        fifoCount -= packetSize;
            ...
            //turn all lights off
            digitalWrite(RED_FW, LOW);
            digitalWrite(RED_BW, LOW);
            digitalWrite(YEL_LEFT, LOW);
            digitalWrite(YEL_RIGHT, LOW);
